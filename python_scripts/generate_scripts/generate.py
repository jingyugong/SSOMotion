...
def main():
    ...
    if args.dataset == 'mixedscenemotion':
        args.dataset = 'humanise'
    ...
    if args.dataset == 'kit':
        fps = 12.5
    elif args.dataset == 'mixedmotion':
        fps = 30
    else:
        fps = 20
    n_frames = min(max_frames, int(args.motion_length*fps))
    is_using_data = args.controlnet or not any([args.input_text, args.text_prompt, args.action_file, args.action_name])
    ...
    if is_using_data:
        ...
        if is_t2m:
            ...
            if args.controlnet and args.hint_ref_file != '':
                hints = [load_random_joint_hint_from_file(args.hint_ref_file)]
