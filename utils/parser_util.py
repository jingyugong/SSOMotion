...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'mixedmotion', 'humanise', 'mixedscenemotion'], type=str,
...
def add_scene_options(parser):
    ...
    group.add_argument("--generate_mode", default="demo", choices=["demo"], type=str,
