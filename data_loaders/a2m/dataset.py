...
class Dataset(torch.utils.data.Dataset):
    ...
    def _get_item_data_index(self, data_index):
        ...
        if hasattr(self, 'controlnet') and self.controlnet:
            output['joint_hint'] = self.get_joint_hint(data_index)
            output['direction_hint'] = self.get_direction_hint(data_index, self.action_to_action_name(action))
            output['scene_hint'] = self.get_void_scene_hint()
